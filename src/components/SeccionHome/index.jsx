...
const SeccionHome = () => {
  ...
  return (
    <div
      id="inicio"
      className="w-full min-h-[850px] relative z-10 overflow-hidden"
      style={{
    ...
    >
      <div className="min-h-[calc(110vh-7.5rem)] sm:min-h-[calc(100vh-7.5rem)] lg:w-[calc(100%-9.99rem)] w-[calc(100%)] lg:left-40 top-30 left-0 relative lg:absolute z-10 flex justify-start items-end ptb-16 wt-850 mtb-16">
        <div className="max-w-full sm:max-w-[480px] text-justify hyphens-auto text-white p-5 sm:pl-12 z-50">
          <p className="text-5xl sm:text-6xl md:text-8xl font-medium font-bebas mp-0">Cristian<span className="text-verde">.</span></p>
          <p className="text-base sm:text-[20px] md:text-2xl font-bold font-roboto mp-1">Desarrollador Full Stack</p> <br />
          <p className="text-sm md:text-base font-roboto">Ingeniero en sistemas con <span className="text-verde">+{years.toFixed(0)} años</span> en desarrollo full stack, enfocado en crear aplicaciones eficientes y funcionales.</p> <br />
